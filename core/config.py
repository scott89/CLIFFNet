...
config.dataset.train_data_file = 'train_uniform_60k.p'
...
config.train.lr_decay_iterations = [45000, 90000, 135000] #, 120000, 160000]
...
config.train.output_path = 'models/nyu_perc_v4.1_r1_10_r2_15/'
